...
export class ModelController {
    ...
    getFlow(): Flow {
        ...
        //   }
        const variable = new Variable(modelStepConfig.variable.key, modelStepConfig.variable.defaultValue, modelStepConfig.variable.description)//, defaultValue = modelStepConfig.variable.defaultValue),//)
